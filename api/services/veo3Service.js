    ...
    try {
      ...
      const result = await model.generateContent({
        contents: [{
          role: 'user',
          parts: [{
            text: `Generate a concise Veo3-optimized video description for this UGC segment:\n\n${prompt}\n\nCreate a single paragraph description optimized for fast Veo3 video generation (8 seconds, UGC style).`
          }]
        }],
        generationConfig: {
          maxOutputTokens: 500,
      ...
      return {
        ...
        message: 'Fast video description generated for Veo3. Use FalAI for actual video generation!'
      };
